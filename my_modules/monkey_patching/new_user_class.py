...
class CustomUser(telegram.User):
    ...
    @property
    def full_name_spoiler(self) -> str:
        '''This will give spoilere design of the name'''
        design_name = f"<tg-spoiler>{self.full_name_no_tag}</tg-spoiler>"
        return design_name

    def full_name_with_link(self):
        '''This is like open the user account with tg 1234 like this'''
        name = self.full_name_no_tag
